...
class TeamMatches extends Component{
    ...
    getTeamMatches=async()=>{
        ...
        const updatedData={
            ...
            latestMatchDetails:{
                ...
                competingTeam:fetchedData.latest_match_details.competing_team_logo,
                ...
                matchStatus:fetchedData.latest_match_details.result,
    ...
    renderLoader=()=>(
        <div testid="Loader" className="loader-container">
            <Loader type="BailTriangle" color="#00fff" height={80} width={80}/>
        </div>
    )
    render(){
